...
export default class Oauth2 extends React.Component {
  ...
  constructor(props, context) {
    ...
    let resource = auth && auth.get("resource") || authConfigs.resource || ""
  ...
  render() {
    ...
    return (
      <div>
        ...
        {
          <Row>
            <label htmlFor={`resource_${flow}`}>resource:</label>
            {
              <Col tablet={10} desktop={10}>
                <InitializedInput id={`resource_${flow}`}
        ...
        <div className="auth-btn-wrapper">
          {isValid &&
            (isAuthorized ? <Button className="btn modal-btn auth authorize" onClick={this.logout}
                                    aria-label="Remove authorization">Logout</Button>
                : <Button className="btn modal-btn auth authorize" onClick={this.authorize}
                          aria-label="Apply given OAuth2 credentials">Authorize</Button>
            )
          }
